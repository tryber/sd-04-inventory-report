...
class SimpleReport:
    ...
    def generate(cls, dataReport):
        ...
        oldest_fab_date = cls.get_oldest_fab_date(dataReport)
        closest_validity = cls.get_closest_validity(dataReport)
        company = cls.get_company_with_more_products(dataReport)
